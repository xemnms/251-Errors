package DemoFolder;
//main class created by Costiniano
...
public class Main_Costiniano3 {
	public static void main(String[] args) {
		...
		SchedulePlanner_Rodenas schedule = new SchedulePlanner_Rodenas("Monday", "10:00", "Recon Mission");
		
		//combines both objects into one mission
		AgentMission_Costiniano mission = new AgentMission_Costiniano(pistol, schedule);
