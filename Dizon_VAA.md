...
**\<04/23/2026\>** : I learned how to build a Spring Boot REST API using @RestController and @GetMapping, and next time I will add more endpoints and try connecting to a real database using Spring Data JPA.
