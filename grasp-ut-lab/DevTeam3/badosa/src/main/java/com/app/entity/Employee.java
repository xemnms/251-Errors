...
public class Employee {
    ...
    // GRASP: Information Expert — Employee contains the salary data, making it the expert responsible for calculating its annual salary.
    public Double calculateAnnualSalary() {
        return this.salary != null ? this.salary * 12 : 0.0;
    }
