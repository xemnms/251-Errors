...
**\<03/14/2026\>** : Today I learned to merge sub-branches in GitHub for better team collaboration and reinforced my understanding of OOP, especially encapsulation. In Main_Bagay, I integrated the GachaCharacterMaker_Nepomuceno and Cat1_Acosta classes, using their constructors, methods, and getters/setters in a small adventure simulation. Next time, I will continue improving my OOP skills and branch management.  
