...
- `refactoring-evidence/before/OrderService.java`
- `refactoring-evidence/after/OrderServiceImpl.java`
...
- Red: identified missing edge cases for null request, invalid item price, invalid item quantity, and missing order records.
- Green: added JUnit 5 and Mockito tests until service, validator, payment, and immutability tests passed.
- Refactor: extracted validation, price calculation, and payment behavior into separate abstractions.
