...
public class Order {
    ...
    // Composition over inheritance: an Order has OrderItems instead of inheriting from them.
    ...
    // Encapsulation: callers cannot directly modify the internal item list.
