...
public class OrderServiceImpl implements OrderService {
    ...
    // DIP: dependencies are injected abstractions, making this service easy to test with Mockito.
    ...
    // DRY: item creation is centralized so mapping logic is not repeated.
