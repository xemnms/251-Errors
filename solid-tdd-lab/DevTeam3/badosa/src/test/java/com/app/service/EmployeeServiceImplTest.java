...
class EmployeeServiceImplTest {
    ...
    void setUp() {
        ...
        service = new EmployeeServiceImpl(repository, notificationService, validator);
        ...
        employee2 = Employee.builder()
                ...
                .department("HR")
                .jobTitle("HR Manager")
                .salaryDetails(com.app.entity.SalaryDetails.builder().baseSalary(4000.0).allowance(500.0).build())
                .build();
